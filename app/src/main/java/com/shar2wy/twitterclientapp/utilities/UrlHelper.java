...
public class UrlHelper {
    ...
    public static final String URL_GET_USER_INFO = BASE_URL+"/1.1/users/show.json";
    public static final String URL_GET_TWEETS = BASE_URL+"1.1/statuses/user_timeline.json";
